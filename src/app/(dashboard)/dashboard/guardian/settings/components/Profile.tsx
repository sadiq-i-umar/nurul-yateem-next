      ...
      <Box>
        ...
        <Box sx={{ display: "flex" }}>
          ...
          <Box sx={{ marginLeft: "30rem", marginTop: "1rem" }}>
            ...
            <Button color="success" sx={{ margin: 2 }}>
              {" "}
              Change{" "}
            </Button>
          </Box>
          ...
          <Box sx={{ padding: "4rem" }}>
            <form>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth variant="outlined">
                    <InputLabel id="state-origin-label">
                      State of Origin
                    </InputLabel>
                    <Select
          ...
          <Box sx={{ padding: "4rem" }}>
            <form>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth variant="outlined">
                    <InputLabel id="nature-of-job-label">
                      Nature of Job
                    </InputLabel>
                    <Select
        ...
        <Box sx={{ display: "flex" }}>
          <Box>
            <Typography
              sx={{ fontSize: "1.125rem", fontWeight: "500", margin: 5 }}
              variant="h3"
            >
              Deactivate Account
            </Typography>
          ...
          <Box sx={{ padding: "2rem", left: "5rem", width: "40rem" }}>
            <Button
              variant="contained"
              color="error"
              sx={{ padding: "0.5rem", width: "40rem", borderRadius: "30px" }}
            >
            ...
            <FormControlLabel
              required
              control={<Checkbox />}
              label="Warning by clicking this box, it means you have initiated the deactivation button."
              sx={{ padding: "0.5rem", width: "40rem" }}
            />
          </Box>
        </Box>
      </Box>
