            ...
            <Box sx={{ display: "flex", paddingTop: "30px", paddingBottom: "20px", paddingX: {xs: "10px", sm: "40px", md: "80px"}, alignItems: "center", borderBottom: "1px solid #DFDFDF", position: "sticky", top: 0, backgroundColor: "white", zIndex: 1, flexDirection: {xs: "column", sm: "row"} }}>
                ...
                <Box sx={{ flexGrow: 1, ...(showSuccessMessage ? { display: "none" } : {display: "flex"}), flexDirection: "column", alignItems: "center", justifyContent: "center", marginX: "30px", marginTop: {xs: "20px", sm: "0px"} }}>
                    <Box sx={{ marginBottom: "20px", textAlign: 'center' }}>
                        <Typography variant="h1" sx={{ fontSize: "20px", display: {xs: "block", sm: "none"} }}>Add an Orphan Account</Typography>
                        <Typography variant="h1" sx={{ display: {xs: "none", sm: "block"} }}>Add an Orphan Account</Typography>
                    </Box>
                    <Box sx={{ textAlign: "center", marginBottom: {xs: "10px", sm: "none"} }}>
                        <Typography sx={{ color: "#8D8B90", display: {xs: "none", sm: "block"} }}>Orphans are vulnerable groups that needs an intervention</Typography>
                        <Typography sx={{ color: "#8D8B90", fontSize: "14px", display: {xs: "block", sm: "none"} }}>Orphans are vulnerable groups that needs an intervention</Typography>
                    </Box>
                </Box>
            ...
            <Box sx={{ paddingTop: "0px", paddingBottom: "25px", borderLeft: "3px solid #E9F3E6", marginLeft: {xs: "20px", md: "90px"}, marginRight: "30px",   marginY: "30px" }}>
                <Box sx={{ display: "flex", alignItems: "center", marginBottom: "50px", marginLeft: "-7.5px" }}>
                    ...
                    <Box sx={{ marginRight: "20px" }}>
                        <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", padding: "15px", borderRadius: "50%", bgcolor: "#E9F3E6", fill: "#268600"}}>
                    ...
                    <Box>
                        <Box><Typography sx={{ fontWeight: "bold" }}>Orphan Details</Typography></Box>
                        <Box><Typography sx={{ color: "#8D8B90" }}>Add an Orphan Profile</Typography></Box>
                    </Box>
                </Box>
            </Box>
            </Grid>
