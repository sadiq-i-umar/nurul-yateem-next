    ...
    return (
        ...
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <Box sx={{ marginBottom: "15px", textAlign: "center" }}>
                <Typography sx={{ fontSize: "30px", fontWeight: "bold" }}>You are almost there!</Typography>
            </Box>
            ...
            <Box>
                <Button onClick={ () => handleContinueClick()} variant="contained" sx={{ boxShadow: "none", width: "100%", borderRadius: "6px", textTransform: "none", paddingY: "10px", paddingX: "70px" }}>
                    Continue
                </Button>
            </Box>
        </Box>
