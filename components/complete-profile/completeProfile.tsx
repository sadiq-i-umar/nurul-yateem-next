"use client";
import { AccountSetup } from "@/src/app/api/service/update-account";
...
const CompleteAccount: React.FC = () => {
  ...
  const { mutateAsync, status, isSuccess, data } = useMutation({
    mutationFn: (payload: any) => AccountSetup(payload, token),
    ...
    try {
      ...
      if (uploadedImage) {
        const payload = {
          ...
          name: meansOfIdentification?.toUpperCase(),
      ...
      <Box>
        <Box
          sx={{
            ...
            alignItems: "center",
            borderBottom: showSuccessMessage ? 0 : "1px solid #DFDFDF",
            position: "sticky",
            top: 0,
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Follow the sample guide to create your account
              </Typography>
              <Typography
                sx={{
                  color: "#8D8B90",
          ...
          >
            <Box sx={{ marginRight: "15px" }}>
              {/**Uncomment when lastName becomes available from the API */}
              {/* <Typography
                style={{ textTransform: 'capitalize' }}
              >{`Welcome ${session?.user.profile.firstName} ${session?.user.profile.lastName}`}</Typography> */}
              <Typography
                style={{ textTransform: "capitalize" }}
              >{`Welcome ${session?.user.profile.firstName}`}</Typography>
            </Box>
            <Box>
              <ProfileImageFrame
                initials={`${session?.user.profile.firstName?.charAt(0)}`}
              />
            </Box>
          </Box>
        </Box>
        ...
        >
                ...
                <Box sx={{ marginRight: "20px" }}>
                  <Box
                    sx={{
                      ...
                      borderRadius: "50%",
                      ...(activeTab == 0
                        ? { bgcolor: "#E9F3E6", fill: "#268600" }
                        : { bgcolor: "#F5F5F5", fill: "#676767" }),
                    }}
                  >
                    <svg
                      width="18"
              ...
              >
                ...
                <Box sx={{ marginRight: "20px" }}>
                  ...
                  >
                    ...
                    >
                      <path
                        d="M4 8V6C4 5.46957 4.21071 4.96086 4.58579 4.58579C4.96086 4.21071 5.46957 4 6 4H8M4 16V18C4 18.5304 4.21071 19.0391 4.58579 19.4142C4.96086 19.7893 5.46957 20 6 20H8M16 4H18C18.5304 4 19.0391 4.21071 19.4142 4.58579C19.7893 4.96086 20 5.46957 20 6V8M16 20H18C18.5304 20 19.0391 19.7893 19.4142 19.4142C19.7893 19.0391 20 18.5304 20 18V16M7 12H17"
                        stroke-width="2"
                ...
                <Box>
                  ...
                  <Box>
                    <Typography>Add an orphan profile</Typography>
                  </Box>
                </Box>
              </Box>
            </Box>
          ...
          <Grid container lg={12}>
            ...
            >
              {activeTab == 0 && (
                <PersonalInformationTab onNextClick={handleDataFromTabOne} />
              )}
              {activeTab == 1 && (
                <OccupationTab onNextClick={handleDataFromTabTwo} />
              )}
              {activeTab == 2 && (
                <IdentityTab onSubmitClick={handleDataFromTabThree} />
              )}
              {activeTab == 1 && (
                <Box sx={{ display: "block", marginBottom: "30px" }}>
                  <Button
