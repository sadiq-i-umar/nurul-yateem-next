...
const Clothing = () => {
  ...
  const [armsLengthError, setArmsLengthError] = useState(false);
  ...
  const sendDataToParent = () => {
    ...
    if (!trouserSize) {
      setTrouserSizeError(true);
      isValid = false;
    }
    if (!armsLength) {
      setArmsLengthError(true);
      isValid = false;
    }
  ...
  const handleYesClick = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        size_of_shirt: shirtSize,
        size_of_trouser: trouserSize,
            ...
            <Box sx={{ marginBottom: "30px" }}>
              <Grid container spacing={5}>
                <Grid item lg={4}>
                  <Box sx={{ marginBottom: "21.5px" }}>
                    <Box sx={{ marginBottom: "11.5px" }}>
                      <Typography>Size of shirt</Typography>
                    </Box>
                    <Box sx={{ borderRadius: "10px" }}>
                      <TextField
                        sx={{
                ...
                <Grid item lg={4}>
                  <Box sx={{ marginBottom: "21.5px" }}>
                    <Box sx={{ marginBottom: "11.5px" }}>
                      <Typography>Size of trouser length</Typography>
                    </Box>
                    <Box sx={{ borderRadius: "10px" }}>
                      <TextField
                        sx={{
                        ...
                        onChange={(event: {
                          ...
                          setTrouserSize(event?.target.value);
                          setTrouserSizeError(false);
                        }}
                      />
                      {trouserSizeError && (
                        <Typography component="p" color="error">
                ...
                <Grid item lg={4}>
                  <Box sx={{ marginBottom: "21.5px" }}>
                    <Box sx={{ marginBottom: "11.5px" }}>
                      <Typography>Arms Length</Typography>
                    </Box>
                    <Box sx={{ borderRadius: "10px" }}>
                      <TextField
                        sx={{
                        ...
                        onChange={(event: {
                          ...
                          setArmsLength(event?.target.value);
                          setArmsLengthError(false);
                        }}
                      />
                      {armsLengthError && (
                        <Typography component="p" color="error">
